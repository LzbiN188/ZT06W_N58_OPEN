...
#ifdef FEATURE_NWY_OPEN_LITE_TTS_OFF
        {"5. TTS", NULL, NULL},
#else
...
static cli_menu_item ble_service_menu_arry[] = 
    {
        ...
        {"6. BLE get status", NULL, nwy_test_cli_ble_get_status},
        ...
        {"24. BLE set adv param", NULL, nwy_test_cli_ble_set_adv_param},
        {"25. BLE add write list", NULL, nwy_test_cli_ble_add_white_list},
        {"26. BLE remove write list", NULL, nwy_test_cli_ble_remove_white_list},
        {"27. BLE clean write list", NULL, nwy_test_cli_ble_clean_white_list},
        {"28. BLE close", NULL, nwy_test_cli_ble_close},
        {"29. BLE set adv data", NULL, nwy_test_cli_ble_set_adv_data},
        {"30. BLE set scanrsp data", NULL, nwy_test_cli_ble_set_scanrsp_data},
        {NULL, NULL, NULL}
    };
